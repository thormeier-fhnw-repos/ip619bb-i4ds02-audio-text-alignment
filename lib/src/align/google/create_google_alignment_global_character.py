...
def create_google_alignment_global_character(google_output: object, transcript: str, verbosity: int) -> List[Sentence]:
    """
    ...
    alignment = needleman_wunsch(google_character_list, transcript_character_list, 5, -1, -1, compare)
