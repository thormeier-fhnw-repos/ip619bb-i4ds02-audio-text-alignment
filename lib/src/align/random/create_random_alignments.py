from lib.src.align.random.create_random_alignment import create_random_alignment
from bin._bin import bin_print
from os import listdir
from os.path import isfile, join


def create_random_alignments(input_path: str, output_path: str, verbosity: int) -> None:
    """
    ...
    for file_pair in file_pairs:
        ...
        alignment = create_random_alignment(file_pair[1], file_pair[2], verbosity)

        output_filename = file_pair[0] + "_audacity_random.txt"
